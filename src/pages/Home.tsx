  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div className="p-6 rounded-2xl shadow-lg bg-white/70 backdrop-blur-md border-t-4 border-indigo-500 transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl animate-float-card animate-fade-pop">
      ...
      <p className="text-slate-600 text-sm text-center">
        Projects built and delivered faster with optimized performance and elegant results.
      </p>
    </div>

    {/* Card 2 */}
    <div className="p-6 rounded-2xl shadow-lg bg-white/70 backdrop-blur-md border-t-4 border-pink-500 transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl animate-float-card animate-fade-pop" style={{ animationDelay: '0.2s' }}>
      ...
      <p className="text-slate-600 text-sm text-center">
        Stunning UI/UX with a perfect balance of functionality and aesthetics.
      </p>
    </div>

    {/* Card 3 */}
    <div className="p-6 rounded-2xl shadow-lg bg-white/70 backdrop-blur-md border-t-4 border-yellow-500 transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl animate-float-card animate-fade-pop" style={{ animationDelay: '0.4s' }}>
      <div className="text-yellow-500 mb-4 text-center">
        <svg className="w-10 h-10 mx-auto" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c1.104 0 2 .896 2 2s-.896 2-2 2-2-.896-2-2 .896-2 2-2z M12 2v2m0 16v2m10-10h-2M4 12H2m16.364 6.364l-1.414-1.414M6.05 6.05L4.636 4.636m12.728 0l-1.414 1.414M6.05 17.95l-1.414 1.414" />
        </svg>
      </div>
